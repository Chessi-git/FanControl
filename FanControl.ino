...
#define VersionString F("Fan Control V0.9 (c) by chessi soft")
#define VersionStringSmall F("** FanControl V0.9 **")
/*
...
byte const FanLut[] PROGMEM  = { 
  225,222,219,216,213,210,207,206,203,200,
  199,196,193,190,187,184,181,178,175,172,
  170,167,165,163,160,157,154,151,149,146,
  144,142,140,138,136,134,132,130,128,126,
  124,122,120,118,116,114,112,110,108,106,
  104,102,100, 99,110,108,106,104,101,100, 
   99, 98, 98, 97, 96, 95, 94, 93, 92, 90, 
   88, 84, 81, 78, 73, 70, 64, 61, 58, 55,
   52, 48, 45, 42, 39, 36, 33, 30, 27, 24,
   21, 19, 16, 14, 12, 10,  8,  4,  1,  0,
   0
};
